    ...
    <div id="content" class="container content-area" role="main">
        ...
        <?php else : ?>
            ...
            <div class="job-overview-content row">
                <div class=" col-md-<?php echo $col_overview; ?> col-sm-12">
                    <div itemprop="description" class="job_listing-description job-overview">
                    ...
                    <div itemscope itemtype="http://data-vocabulary.org/Organization" class="job_listing-company-description job-company-about">
